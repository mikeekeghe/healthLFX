 ...
 * @author Eche Michael
 */
public class TodayReportController implements Initializable {
    ...
    private final String REPORT_NAME = "TODAY_REPORT";
    private String path;
    String strTotal;
    String strTotalExp;
    String strBallance;
    ...
    private void refreshList() {
        ...
        try {
            ...
            String todRepQuery = "SELECT * FROM Appointment_tbl WHERE txnDay ='" + theDay + "'"
                    + " ORDER BY " + orderby;
            ...
            while (rs.next()) {
                ...
                System.out.println("notes = " + type);
                System.out.println("notes = " + room);
                System.out.println("notes = " + invoiceNo);
    ...
    private int calculateMyTotal() {
        ...
        try {
            ...
            String totQuery = "SELECT SUM(amount) FROM Appointment_tbl WHERE txnDay = '" + theDay + "'";
    ...
    private int calculateMyTotalExp() {
        ...
        try {
            ...
            conn = DriverManager.getConnection("jdbc:sqlite:dbhealthline.db");
            stmt = conn.createStatement();
            String totQuery = "SELECT SUM(amount) FROM ExpAmount_tbl WHERE txnDay = '" + theDay + "'";
